...
- **Dernier redéploiement** : 20 sept. 2026 — Stream : 4 scènes spectateur + plexus audio rec/live ; rsync `studio/` ; `pm2 restart hakou-studio` ; GitHub Pages `scene3d.js` / `solar-plexus.js`.
