...
- **SoundCloud** : embed officiel ; couleur accent `%237f9dff` dans l’URL du player. Mobile (`≤680px`) : iframe **interactive** (`pointer-events: auto`, `touch-action: manipulation`) ; scroll du panel sur le texte / marges de la carte ; repli lien profil sous le lecteur.
