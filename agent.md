...
- **Studio visuel / ceintures** (20 sept. 2026) : **un seul système solaire** = [`scene3d.js`](scene3d.js) + plexus [`solar-plexus.js`](solar-plexus.js) (4 ceintures toujours visibles). **Spectateur Stream** (§2) : 4 scènes (Principale / L4 / Kuiper / Saturne) via [`stream-scenes.js`](stream-scenes.js) — caméra héro, indépendante du cadrage Uranus. **Studio rec/live** : audio → `setAudioVibe` / `tickPlexus`, tous les plexus dansent. Cache-bust `?v=20260920m`. **Login Google Cursor** : tester dans Chrome. Aperçu : `index.html?preview=1`.
