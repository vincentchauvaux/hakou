...
| **Sites** (`#venus`, `data-zone="6"`) | [RPG CR](https://vps-e09ed6db.vps.ovh.net/rpg-cr/) + [Hirakana](https://vps-e09ed6db.vps.ovh.net/hirakana/) + [Canopée](https://xn--canope-fva.be/) ([canopée.be](https://xn--canope-fva.be/)) + [LM Studio](https://lmstudio.ai/download) | Nav libellé **Sites** (icône globe mobile). Grille **`.sites-grid`** : 2 cartes Hakou (RPG CR, Hirakana) + **Canopée** en bandeau pleine largeur (`.site-card--feature`, kicker « Pour ma maman », CTA « Visiter canopée.be »). Orbite 3D : planète Vénus inchangée (`SECTION_COUNT` = 9). |
