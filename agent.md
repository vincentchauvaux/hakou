...
| **Sites** (`#venus`, `data-zone="6"`) | [RPG CR](https://vps-e09ed6db.vps.ovh.net/rpg-cr/) + [Hirakana](https://vps-e09ed6db.vps.ovh.net/hirakana/) + [Canopée](https://xn--canope-fva.be/) ([canopée.be](https://xn--canope-fva.be/)) + [LM Studio](https://lmstudio.ai/download) | Nav libellé **Sites** (icône globe mobile). Grille **`.sites-grid`** : 3 cartes `.site-card` — **RPG CR** (JDR narratif univers Hakou, LLM local via LM Studio ; CTA primaire « Ouvrir RPG CR », secondaire « LM Studio ») ; **Hirakana** (CTA « Ouvrir Hirakana ») ; **Canopée** (site de sa maman, domaine canopée.be / `xn--canope-fva.be` ; CTA « Ouvrir canopée.be »). Orbite 3D : planète Vénus inchangée (`SECTION_COUNT` = 9). |
