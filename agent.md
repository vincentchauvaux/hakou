...
- **Studio visuel / ceintures** (20 sept. 2026) : page studio = fond système solaire Three.js ([`studio/public/studio-space.js`](studio/public/studio-space.js)) + cartes verre. Live = **son + champ d’astéroïdes plexus** ([`studio/public/studio-viz.js`](studio/public/studio-viz.js)), plus de `getDisplayMedia` vidéo. 4 ceintures au choix : **principale** (Mars–Jupiter), **Troyens de Jupiter**, **Kuiper**, **anneaux de Saturne**. Audio : entrée (BlackHole / Rekordbox / micro) ou son d’onglet Chrome (piste écran jetée). Capture WHIP = canvas 1280×720 + pistes audio. Cache-bust `?v=20260920f`. Le canvas `#studio-space` **est** le live (plus de cadre visualiseur). Dock compact sous un vide pour voir le système. 4 spots : Principale, L4, Kuiper, Saturne. Capture WHIP = ce canvas 1280×720. [`studio-viz.js`](studio/public/studio-viz.js) sur le fond ; [`studio-space.js`](studio/public/studio-space.js) réexporte. **Login Google Cursor** : tester dans Chrome. Aperçu : `index.html?preview=1`.
